...
{
public:
    virtual void fillSchedule(std::vector<finDate>& paymentDates, const finDate& start, const finDate& maturity, const int freq) = 0;
...
{
public:
    void fillSchedule(std::vector<finDate>& paymentDates, const finDate& start, const finDate& maturity, const int freq) override final;
