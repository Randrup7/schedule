...
void dayAdjustment::MF::adjustDate(finDate& date, std::unique_ptr<I_holidayCalendar> calendar = nullptr)
{
...
void dayAdjustment::F::adjustDate(finDate& date, std::unique_ptr<I_holidayCalendar> calendar = nullptr)
{
    std::chrono::weekday wd{ std::chrono::sys_days(date.year_month_day()) };
...
void dayAdjustment::P::adjustDate(finDate& date, std::unique_ptr<I_holidayCalendar> calendar = nullptr)
{
    std::chrono::weekday wd{ std::chrono::sys_days(date.year_month_day()) };
